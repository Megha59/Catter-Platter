...
--
-- Host: 127.0.0.1
-- Generation Time: Jan 08, 2021 at 04:43 PM
...
('Megha', 'Megha', 'meghass029@gmail.com', '9110475944', 'arsikere', 'megha');
...
(58, 'Vegetable-65', 40, 'Juicy Masala Paneer Kathi Roll loaded with Masala Paneer chunks, onion & Mayo.', 1, 'images/Vegetable-65.jpg', 'DISABLE'),
...
(80, 'Chinese-veg platter 1', 200, '1)Starter - smoky tofu dumplings with sweet chilli dippings. (2)Main course - Vegan vegetable Lo Mein. (3) Add on - Sticky Lemon cauliflower', 7, 'images/chinese/chinese-veg-1.jpg', 'ENABLE'),
(81, 'Chinese-veg platter 2', 200, '(1) Starter - Veggie Scallion Pancakes. (2)Brussels sprout fried rice with baked tofu. (3) Add on - Sticky sesame cauliflower.', 7, 'images/chinese/chinese-veg-2.jpg', 'ENABLE'),
(82, 'Chinese non-veg platter', 300, '(1)Starter - Spring Rolls.(2)Main course - Chicken fried rice (3) Add on  - Peri peri chicken.', 7, 'images/chinese/chinese-non-veg-1.jpg', 'ENABLE'),
(83, 'North-Indian Veg platter', 200, '(1) Starter - Paneer Tikka. (2) Main course - Butter Kulcha with kaju masala.(3)Main course - Veg Biriyani. (4)Dessert - Gulab Jamun.', 9, 'images/north indian/north-indian-veg.jpg', 'ENABLE'),
(84, 'North-Indian Non Veg platter', 300, '(1) Starter - Cheesy Chicken tikka. (2) Main course - Butter Kulcha with Lemon Chicken. (3) Main course - Chicken Biriyani. (4) Dessert - Rasgulla.', 9, 'images/north indian/non-veg.jpg', 'ENABLE'),
(85, 'South-Indian Veg platter', 250, 'Pickle,Chilli bajji, Sweet corn kosambari, Poori(2)-Saagu, white rice,sambar,Shaavige paayasa, paapad,curd rice', 3, 'images/south indian/veg.jpg', 'ENABLE'),
(86, 'South-Indian Non Veg platter', 350, 'Tandoori chicken, chicken tikka, white rice,mutton curry,mysore paak, curd rice, hyderabadi biriyani', 3, 'images/south indian/non veg.jpg', 'ENABLE'),
(87, 'Italian Veg platter', 250, '(1)Appetizer - Eggplant Gratin. (2)Veggie loaded pizza. (3) White/red sauce Pasta.(4)Spinach and Ricotta Gnudi with tomato butter sauce.', 10, 'images/italian/veg.jpg', 'ENABLE'),
(88, 'Italian Non Veg platter', 350, '(1)Starter - Meat balls. (2)Non-veg loaded pizza. (3) Non-veg Pasta. (4) Free-form sausage and three-cheesy Lasagna', 10, 'images/italian/non veg.jpg', 'ENABLE');
...
('manasa', 'manasa', 'manasa@gmail.com', '9874563210', 'Koorgalli, Mysore', 'manasa'),
('megha', 'megha', 'meghass029@gmail.com', '9110475944', 'arsikere', 'megha'),
('roshanraj07', 'Roshan Raj', 'roshan@gmail.com', '9541258761', 'Bihar', 'roshan'),
('sahana', 'Sahana', 'sahana@gmail.com', '9611606646', 'Vijayanagar, Mysore', 'sahana');
...
(69, 60, 'Chocolate Hazelnut Truffle', 99, 1, '2020-11-20', 'Megha', 3),
(70, 61, 'Happy Happy Choco Chip Shake', 80, 1, '2020-11-20', 'Megha', 1),
(71, 60, 'Chocolate Hazelnut Truffle', 99, 1, '2020-11-20', 'Megha', 3),
(72, 61, 'Happy Happy Choco Chip Shake', 80, 1, '2020-11-20', 'Megha', 1),
(73, 83, 'North-Indian Veg platter', 200, 13, '2021-01-08', 'Megha', 9);
...
(7, 'Megha Siddappa Restaurant', 'meghasiddappa@gmail.com', '9110475944', 'Hootagalli, Mysore', 'megha'),
(9, 'Sahana Suresh Restaurant', 'sahanasuresh@gmail.com', '9611606646', 'Vijayanagar, Mysore', 'sahana'),
(10, 'Manasa Restaurant ', 'manasa@gmail.com', '9874563210', 'Koorgalli, Mysore', 'manasa');
...
--
ALTER TABLE `orders`
  MODIFY `order_ID` int(30) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=74;
