...
<html>
  ...
  <head>
    <title> Explore | Food Sahmeg </title>
  </head>
...
<div class="jumbotron">
  <div class="container text-center">
    <h1>Welcome To Sahmeg</h1>      
    <p>Let food be the medicine and medicine be the food</p>
  </div>
</div>

<div>
      <h1 style="text-align: center; background-color: darkgray"><b> Get your customized platters here</b></h1>
    </div>

<div>
  <h3> Various Cuisines Platters</h3>
</div>
