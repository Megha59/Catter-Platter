...
if(!empty($_SESSION["cart"]))
{
  ...
  <div class="container">
      <div class="jumbotron">
        ...
        <p>Looks tasty...!!!</p>
        <p>For each supplier we'll cost Rs.500/supplier</p>
      </div>
...
<td><?php echo number_format($values["food_quantity"]/10); ?> </td>
<td><a href="cart.php?action=delete&id=<?php echo $values["food_id"]; ?>"><span class="text-danger">Remove</span></a></td>
</tr>
<?php 
$food_total = $food_total + ($values["food_quantity"] * $values["food_price"]);

if(($values["food_quantity"]/10)>1){
$total = $total + ($values["food_quantity"] * $values["food_price"] + (($values["food_quantity"]/10)*500));
}
else{
...
?>
<tr>
<td colspan="2" align="right">Food Total</td>
<td align="right">&#8377; <?php echo number_format($food_total, 2); ?></td>
<br>  
<br>
